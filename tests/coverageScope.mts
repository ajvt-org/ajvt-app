export const DATABASE_BOUND_LIB = [
  ...
  "src/lib/memberImportRunServer.ts",
  ...
  "src/lib/membershipAddServer.ts",
  ...
  "src/lib/teamFollowServer.ts",
  "src/lib/teamInvitesServer.ts",
  "src/lib/teamJoinServer.ts",
  "src/lib/teamMoveServer.ts",
  "src/lib/teamRosterServer.ts",
  "src/lib/mvpVoteServer.ts",
  "src/lib/peopleServer.ts",
  "src/lib/personDeleteServer.ts",
  "src/lib/prisma.ts",
  ...
  "src/lib/quizImportServer.ts",
  "src/lib/quizNotify.ts",
  "src/lib/quizPoolServer.ts",
  "src/lib/quizQuestionEditServer.ts",
  "src/lib/quizQuestionsServer.ts",
  ...
  "src/lib/restoreRecordServer.ts",
  "src/lib/samePersonServer.ts",
  "src/lib/scheduleShiftNotify.ts",
  "src/lib/signInServer.ts",
  "src/lib/selfMemberReadServer.ts",
  "src/lib/selfMembershipServer.ts",
  "src/lib/selfRenewServer.ts",
  "src/lib/selfRegisterServer.ts",
