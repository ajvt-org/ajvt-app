export const ACTION_LABELS = {
  ...
  DISABLE_TEAM: "تعطيل فريق",
  ENABLE_TEAM: "إرجاع فريق",
  ...
  CREATE_ELECTION: "إنشاء انتخاب",
  UPDATE_ELECTION: "تعديل انتخاب",
  PUBLISH_ELECTION: "نشر انتخاب",
  HIDE_ELECTION: "إخفاء انتخاب",
