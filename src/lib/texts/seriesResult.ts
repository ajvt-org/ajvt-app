export const seriesResult = {
  ...
  worthByRule: (name: string, worth: string) => `${name}، تُحتسب ${worth}`,
  worthOff: (name: string) => `${name} موقوفة على هذه الوحدة`,
  turnWorthOff: "لا تُطبَّق هنا",
  turnWorthOn: "أعِد تطبيقها",
