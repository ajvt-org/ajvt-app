...
export const matchAdmin = {
  ...
  roundLabel: "الجولة",
  venueLabel: "الملعب",
  knockoutMatch: "مباراة خروج المغلوب",
  saveDetails: "حفظ التفاصيل",
  motmOptional: "رجل المباراة (اختياري)",
  motmNone: "بدون",
  ...
  entrant: {
    team: {
      confirmDraw:
        "إجراء قرعة عشوائية بين جميع الفرق الحالية؟ من لا يجد خصماً يمرّ إلى الدور التالي.",
    },
    player: {
      confirmDraw:
        "إجراء قرعة عشوائية بين جميع اللاعبين الحاليين؟ من لا يجد خصماً يمرّ إلى الدور التالي.",
    },
  },
} as const;
