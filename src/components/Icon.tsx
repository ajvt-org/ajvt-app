const PATHS = {
  ...
  eyeClosed:
    "M3 8c2.4 3.7 5.6 5.5 9 5.5s6.6-1.8 9-5.5M12 13.5L12 16.7M7.1 12.1L5.6 15M16.9 12.1L18.4 15",
  idCard:
  ...
  unlink:
    "M10 13a5 5 0 0 0 7.5.5l3-3a5 5 0 0 0-7-7l-1.7 1.7M14 11a5 5 0 0 0-7.5-.5l-3 3a5 5 0 0 0 7 7l1.7-1.7M5.6 5.6l12.8 12.8",
  ...
  jersey:
    "M4.4 7.6L3.2 2l4.6 2.8L12 1.2l4.2 3.6L20.8 2l-1.2 5.6zM9.4 10.8L5.2 12.4 3.9 16.2l2.7.9V22h10.8v-4.9l2.7-.9-1.3-3.8-4.2-1.6M9.4 10.8a3 2.4 0 0 0 5.2 0",
  medal:
  ...
  ballot: "M4 12h16v9H4zM8 12V4h8v8M10.5 7.5h3",
